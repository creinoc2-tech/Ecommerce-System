...
export const Newsletter = () => {
  return (
    <div className='relative bg-gray-500 text-white py-20'>
        ...
        <div className=' mx-auto p-4 w-full max-w-screen-xl  z-10 relative  p-5 md:p-0'>
            <div className='w-full text-black bg-white p-12 space-y-5 md:w-[50%] lg:w-[40%]'>
                <p className='text-xs uppercase font-semibold'>
                    ...
                    <form className='flex flex-col gap-5 xl:flex-row '>
                        <input type="email" 
						className='border border-slate-200 focus:outline-none rounded-full 
                        py-3 px-5 w-full text-xs font-medium'
                        placeholder='Correo electrónico'
                        />

                        <button 
                        className='bg-black text-white font-semibold rounded-full uppercase
                         tracking-wider py-3 text-xs xl:px-5'>
                            Suscribirse
                        </button>
                    </form>
